(function ($) {
    ...
    $("[data-bg-image]").each(function () {
        ...
        // var img = "https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE4wyTr?ver=ecf5";
        var img = "https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOE58C.img";
        $(this).css({
